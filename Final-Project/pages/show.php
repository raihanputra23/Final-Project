    ...
    <tbody>
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <!-- <a href="../backend/edit.php id=<?= $row['id']; ?>" class = "button is-warning is-light" data-target = "#modal">Edit</a> -->
                    <button onclick="openModal();" class="button is-warning is-light">Edit</button>
                    <a href="../backend/delete.php id=<?= $row['id']; ?>" class="button is-danger is-light">Hapus</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
            ...
            <section class="modal-card-body">
                <form method="post" action="./../backend/edit.php" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            ...
                            <a class="button is-danger mt-4" href="show.php">Cancel</a>
                         </div>
